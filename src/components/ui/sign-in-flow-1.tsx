...
function MiniNavbar() {
  ...
  return (
    <header
      className={`fixed top-6 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center pl-6 pr-6 py-3 backdrop-blur-sm ${headerShapeClass} border border-[#333] bg-[#1f1f1f57] w-[calc(100%-2rem)] sm:w-auto transition-[border-radius] duration-300 ease-in-out`}
    >
...
export const SignInPage = ({ className, onEmailSubmit, onCodeComplete }: SignInPageProps) => {
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.8rem] text-white/70 font-light">Sign in to SiteIQ</p>
                    </div>
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.25rem] text-white/50 font-light">Welcome to SiteIQ</p>
                    </div>
